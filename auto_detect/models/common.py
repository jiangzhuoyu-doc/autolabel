...
from auto_detect.utils import TryExcept
from auto_detect.utils.dataloaders import exif_transpose, letterbox
from auto_detect.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
                           increment_path, is_notebook, make_divisible, non_max_suppression, scale_boxes,
                           xywh2xyxy, xyxy2xywh, yaml_load)
from auto_detect.utils.plots import Annotator, colors, save_one_box
from auto_detect.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from auto_detect.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from auto_detect.export import export_formats
        from auto_detect.utils.downloads import is_url
